# [\#145 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/145) `open`: Remove requirement to add a NodePath for every vertex in SoftBody3D - cannot select objects: crashes inspector.
