...
defmodule VSekaiNebula.Mode do
  ...
  - `:id`: A unique identifier for each mode. It is autogenerated and is the primary key.
  """
...
defmodule VSekaiNebula.Version do
  ...
  - `:id`: A unique identifier for each version. It is autogenerated and is the primary key.
...
defmodule VSekaiNebula.Files do
  ...
  - `:id`: A unique identifier for each file. It is autogenerated and is the primary key.
...
defmodule VSekaiNebula.CDN do
  ...
  - `:id`: A unique identifier for each CDN. It is autogenerated and is the primary key.
