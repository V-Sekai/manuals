...
We have 100 players per world server. This gives us 100 x 10 x 10 = 10,000 bytes per second, or 80,000 bits per second.
...
| Server Type         | Operation | Frequency | Transactions per Second | Player Count | World Count |
| ------------------- | --------- | --------- | ----------------------- | ------------ | ----------- |
| Player              | Write     | 100 FPS   | 100 writes/sec          | 10,000       | N/A         |
| World               | Write     | 100 FPS   | 100 writes/sec          | N/A          | 100         |
| Game State Delivery | Read      | 100 FPS   | 100 reads/sec           | 10,000       | 100         |
