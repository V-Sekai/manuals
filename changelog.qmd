...
for f in files:
    ...
    rows.append({"filename": filename, "title": link, "reading-time": reading_time, })

# Always create DataFrame with all columns, and only sort if not empty
columns = ["filename", "title", "reading-time"]
