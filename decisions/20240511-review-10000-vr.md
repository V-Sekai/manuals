# Proposed: VR Game with 1000 Players
...
# Requires 125 player servers for 1,000 players
extends Node
...
This list can then be used to generate the 1 mbit/sec stream of packets that is sent from each world server. The total of 100 mbit generated per second is achieved by running this process across all 125 world servers.
...
| Server Type         | Operation | Frequency | Transactions per Second | Input Count | Output Count |
| ------------------- | --------- | --------- | ----------------------- | ----------------------- | - |
| Player              | Write     | 100 FPS   | 100 writes/sec          | 80                      | 125 |
| World               | Write     | 100 FPS   | 100 writes/sec          | 125                      |  125 + 80 |
