...
# Compute Pareto front using pymoo (non-dominated sorting)
try:
    from pymoo.util.non_dominated_sorting import NonDominatedSorting
    # For Priority vs Latency: we want to maximize both Priority and Latency (older is better)
    # NonDominatedSorting assumes minimization, so negate objectives we want to maximize.
    ...
    # fallback to simple greedy method if pymoo isn't available
...
# Compute Pareto for Effort vs Priority using pymoo
try:
    # Effort: minimize, Priority: maximize -> use Effort and -Priority for minimization
...
# Compute Pareto for Effort vs Latency using pymoo
try:
    # Effort: minimize, Latency: maximize -> use Effort and -Latency
