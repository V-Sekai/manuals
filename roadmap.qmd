...
- **X-axis (Effort):** Estimated work required (lower is better).
- **Y-axis (Latency):** Age of the task in days (reversed, older tasks at bottom).
- **Pareto Frontier:** Dotted line shows the optimal trade-off between effort and age.
- **Interpretation:** Top-left tasks are low effort and younger—evaluate if these newer tasks warrant attention.
