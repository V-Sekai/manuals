# [\#141 Issue](https://github.com/V-Sekai/manuals/issues/141) `closed`: Thread-correctness assets (ENSURE_MAIN_THREAD, etc.) For example, EditorProgress should not allow creating progress bar UI from a thread
**Labels**: `archived`
