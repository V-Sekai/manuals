...
- Status: Draft
- Deciders: V-Sekai
- Tags: V-Sekai, Dokku, Backend, Hosting, Development, 20230804-dokku
...
- Dokku has features that could allow us to scale our applications based on demand.
- Dokku's git-based deployment system might simplify the process of deploying new versions of our applications.
- Dokku's use of Docker containers could lead to more efficient use of system resources.
