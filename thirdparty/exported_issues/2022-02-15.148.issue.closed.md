# [\#148 Issue](https://github.com/V-Sekai/V-Sekai/issues/148) `closed`: Fix FBX importer low hanging fruit including blender files (same features as unity or official sdk)
