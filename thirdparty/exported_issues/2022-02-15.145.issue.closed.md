# [\#145 Issue](https://github.com/V-Sekai/manuals/issues/145) `closed`: Remove requirement to add a NodePath for every vertex in SoftBody3D - cannot select objects: crashes inspector.
