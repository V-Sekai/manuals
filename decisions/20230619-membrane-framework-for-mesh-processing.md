...
- Zone-level resilience with primary cluster nodes across multiple zones.
- Timeline consistency in replica clusters, better than eventual consistency.
- Quick reads from primary and replica clusters; write latency depends on client-primary cluster distance.
