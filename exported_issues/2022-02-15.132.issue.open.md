# [\#132 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/132) `open`: Add missing return types to rset_get_mode and rpc_get_mode (MultiplayerAPI::RPC_MODE_DISABLED;)
