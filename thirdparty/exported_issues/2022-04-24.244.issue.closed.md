# [\#244 Issue](https://github.com/V-Sekai/manuals/issues/244) `closed`: Bug where OpenXR returning the wrong tracking universe in vr::VRCompositor()->GetTrackingSpace()
**Labels**: `archived`
