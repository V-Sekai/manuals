# [\#246 Issue](https://github.com/V-Sekai/manuals/issues/246) `closed`: Fix "Enforce Strict T-Pose" to point in the correct direction. OR, fix "Fix Avatar" to point bones in the correct direction.
**Labels**: `archived`
