...
**Creators:** Avatar and 3D asset makers in the Japanese doujin economy and the global VRChat/VRM creator community. This audience already attends virtual market events. Virtual Market (バーチャルマーケット), run by Hikky, drew over 1.3 million visitors worldwide and holds a Guinness World Record as the world's largest VR event @hikky2025. The format is proven; no self-hostable alternative exists.

**Organizers:** Fan convention organizers — anime, gaming, cosplay — who want a persistent virtual venue without platform risk. Rec Room shut down in March 2026 after reaching 150 million registered users, stranding every community that had built events on that platform @recroom2026. Self-hostability is now a trust argument.

**Attendees:** Desktop users with no headset. Alife Virtual reached 1.1 million users on a desktop-only client @alife2025. Approximately 50% of VRChat sessions use desktop mode even after the iOS and Android launch @vrchat2025. Meta's own data showed that desktop and mobile users were more engaged than headset users within Meta's own ecosystem, which drove Horizon Worlds to pivot away from VR as its primary surface @horizon2026. The total addressable audience is larger without a headset requirement than with one.
...
Linietsky reports that approximately one in ten funded games succeeds and only two or three recover their investment @linietsky2017. Infrastructure products follow different economics: revenue is recurring, not launch-concentrated, and the comparison is a developer tools business, not a game release.
...
Differentiation must be communicable in one sentence, one image, or one short video @linietsky2017. The sentence above passes this test. The table above is the image.
