...
- We will leverage our existing contacts within the VR community to gain our first 50 users.
- We will offer unique experiences not found on other platforms to attract more users.
- To reach thousands of users, we will host events and emphasize privacy and self-hosting capabilities.
...
- Most social VR applications are developed in Unity, which can present design challenges for our Godot Engine-based project.
- Social platforms are heavily influenced by the network effect, making user acquisition a challenge.
- VR applications tend to have lower user retention rates compared to traditional applications.
...
- C++. Familiar with Godot Engine and Unreal Engine. Professional game developer. Created a Blender to glTF2 pipeline for Godot Engine and coordinated an FBX pipeline. Shipped Offworld Industries’ Squad as a programmer, DevOps, and IT. Implemented an Unreal Engine touchscreen product demo using HTML5 and Blueprints.

**Will all team members commit their full-time energy to this project during the 8 weeks of the program?**

- Making valuable individual contributions as needed, including a VR character movement system.
- Will be working full-time on the core client.
- Will be working full-time on dev ops, operations, backend, and testing.
- Heavily involved in the Godot Engine open-source community and dedicated part-time to this MVP project.
