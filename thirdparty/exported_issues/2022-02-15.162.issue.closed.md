# [\#162 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/162) `closed`: Search godot shader database and cherry-pick an example light() function and see if it works in godot 4
