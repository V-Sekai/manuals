# [\#170 Issue](https://github.com/V-Sekai/manuals/issues/170) `closed`: GDScript should be able to manually reimport a file and wait until it's done (EditorFIleSystem.import_file doesn't do anything)
