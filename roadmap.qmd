...
# Use Latency as x-axis, Effort as y, Priority as z, and Effort for marker size
...
fig = px.scatter_3d(
    ...
    title='Feature Roadmap (3D): Latency vs Effort vs Priority (Pareto Frontier, Effort-Scaled)',
    labels={'Latency': 'Age (days)', 'Effort': 'Effort (1-100 Scale)', 'Priority': 'Priority', 'Created_on': 'Created'}
)
fig.show()
