# [\#217 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/217) `closed`: To know which are maps and avatars are compatible, add date and version number to maps list
**Labels**: `enhancement`
