...
defmodule VSekaiNebula.Version do
  ...
  - `:manifest_file_uri`: The URI of the manifest file.
  - `:manifest_file_checksum_hash`: The checksum hash of the manifest file.
  ...
  schema "versions" do
    ...
    field :manifest_file_checksum_hash, :string
    field :id, Ecto.UUID, autogenerate: true, primary_key: true
...
defmodule VSekaiNebula.CDN do
  ...
  - `:last_checked_on`: The date and time when the CDN was last checked.
