# [\#3 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/3) `closed`: General-purpose retargeting system for VRM type models and encoding in BVH (3d pose format)
