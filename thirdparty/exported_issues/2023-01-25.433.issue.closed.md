# [\#433 Issue](https://github.com/V-Sekai/V-Sekai/issues/433) `closed`: To make the community easier: Grant the "Member" role to all members who click a reaction from the Discord bot.
**Labels**: `enhancement`
