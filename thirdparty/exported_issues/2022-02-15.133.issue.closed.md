# [\#133 Issue](https://github.com/V-Sekai/V-Sekai/issues/133) `closed`: "Clear existing lightmap data when assigning new data" call clear_data in clear_data for BakedLightmap
**Labels**: `archived`
