...
for f in files:
    ...
    # Construct the URL based on the file path relative to the decisions directory
    relative_path = os.path.relpath(f, '.').replace(".md", ".html")
    url = f"https://v-sekai.github.io/manuals/{relative_path}"
