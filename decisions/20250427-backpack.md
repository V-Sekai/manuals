...
Godot Engine's V-Sekai project requires a scalable recommendation system (200k+ user-items) with modern metadata handling. The current implementation does not exist. The decision to use standard Elixir Phoenix is driven by the fact that our backend (uro) is already implemented in Elixir, ensuring seamless integration and using existing expertise. Integration with Python-based ML libraries like librecommender will be handled using pythonx.
...
- Uses Elixir's concurrency for handling recommendation requests.
- Uses mature Python ML ecosystem (librecommender) without rewriting algorithms.
...
[@phoenix_framework_2024]: "Phoenix Framework."  <https://www.phoenixframework.org/>
[@pythonx_documentation_2024]: "Pythonx Documentation."  <https://hexdocs.pm/pythonx/Pythonx.html>
[@vsekai_roadmap_2025_2024]: "V-Sekai Roadmap 2025."  <https://v-sekai.github.io/manuals/roadmap.html>
[@librecommender_serving_guide_2024]: "Librecommender Serving Guide." (Note: We are using Python via pythonx, not the Rust serving directly) <https://librecommender.readthedocs.io/en/latest/serving_guide/rust.html>
[@deep_interest_network_2024]: "Deep Interest Network for Click-Through Rate Prediction."  <https://arxiv.org/abs/1706.06978>
[@oban_2024]: "Oban."  <https://hexdocs.pm/oban/Oban.html>
[@membrane_framework_2024]: "Membrane Framework."  <https://membraneframework.org/>
