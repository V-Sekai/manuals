# [\#112 Issue](https://github.com/V-Sekai/V-Sekai/issues/112) `closed`: Remove limit on copying and duplicating scene nodes. Can copy any node in the circumstance of instanced nodes or inherited.
