...
gantt
    ...
    Implement FBX for glTF :a1, 2018-12-01, 2022-04-30
    Godot 4.0 development  :a5, 2019-03-01, 2023-03-31
    Debug/fix glTF import  :a2, 2019-07-01, 2019-08-12
    Implement glTF export  :a4, 2021-01-04, 2021-01-04
    Remove REST transform  :a10, 2021-10-13, 2021-10-13
    Replace 3D transform   :a11, 2021-10-13, 2021-10-13
    Add animation compression :a8, 2021-10-25, 2021-10-25
    Implement Animation Libraries :a6, 2022-04-11, 2022-04-11

    section Blender Fixes & Features
    Fix glTF import        :a3, 2020-05-01, 2020-05-31
    Add Blender import     :a7, 2021-11-11, 2021-11-11

    section Additional Features
    Add AnimationTree Advanced Expressions :a9, 2022-05-19, 2022-05-19
```
