# [\#140 Issue](https://github.com/V-Sekai/V-Sekai.github.io/issues/140) `open`: Add an offset and length parameter to MultiplayerAPI's send_bytes method. (Explain why .subarray() is insufficient. Performance?)
