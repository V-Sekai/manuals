...
- Status: Draft&#x20;
- Deciders: V-Sekai
- Tags: V-Sekai, 20231229-byobu

## The Backdrop

In the world of software development, having a reliable and user-friendly terminal environment is crucial. Developers often need to manage multiple terminal sessions at once, which can be challenging without the right tools.
...
Our strategy is to use Byobu, a GPLv3 open source text-based window manager and terminal multiplexer. It was chosen for its ease of use and reliable feature set.
