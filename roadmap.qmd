...
fig_ep = px.scatter(
    ...
    labels={'Effort': 'Effort (1-100 Scale)', 'Priority': 'Priority', 'Pareto_EP': 'Pareto Frontier', 'Created_on': 'Created', 'Latency': 'Age (days)'}
)
...
fig_pl = px.scatter(
    ...
    size=effort_sizes,
    hover_data=['Category', 'Notes', 'Effort', 'Priority', 'Latency', 'Created_on'],
    title='Feature Roadmap: Priority vs Latency (Effort Size)',
    labels={'Effort': 'Effort (1-100 Scale)', 'Priority': 'Priority', 'Latency': 'Age (days)', 'Created_on': 'Created'}
)
fig_pl.show()
...
fig_el = px.scatter(
    ...
    size=effort_sizes,
    hover_data=['Category', 'Notes', 'Effort', 'Priority', 'Latency', 'Created_on'],
    title='Feature Roadmap: Effort vs Latency (Effort Size)',
    labels={'Effort': 'Effort (1-100 Scale)', 'Latency': 'Age (days)', 'Priority': 'Priority', 'Created_on': 'Created'}
)
