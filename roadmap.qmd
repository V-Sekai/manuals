...
def plot_effort_priority(df, effort_sizes):
    fig_ep = px.scatter(
        ...
        labels={'Effort': 'Effort (1-100 Scale, lower is better)', 'Priority': 'Priority', 'Pareto_EP': 'Pareto Optimal', 'Created_on': 'Created', 'Latency': 'Age (days)'}
    )
    ...
    if len(pareto_points_ep) > 1:
        pareto_line_ep = go.Scatter(
            x=pareto_points_ep[:,0],
            y=pareto_points_ep[:,1],
            mode='lines+markers',
...
def plot_priority_latency(df, effort_sizes):
    fig_pl = px.scatter(
        ...
        size=effort_sizes,
        hover_data=['Task', 'Category', 'Notes', 'Effort', 'Priority', 'Latency', 'Created_on'],
        title='Feature Roadmap: Priority vs Latency (Pareto Frontier)',
        labels={'Effort': 'Effort (1-100 Scale, lower is better)', 'Priority': 'Priority', 'Pareto_PL': 'Pareto Optimal', 'Latency': 'Age (days)', 'Created_on': 'Created'}
    )
    ...
    if len(pareto_points_pl) > 1:
        pareto_line_pl = go.Scatter(
            x=pareto_points_pl[:,0],
            y=pareto_points_pl[:,1],
            mode='lines+markers',
            name='Pareto Frontier',
            line=dict(color='orange', width=3, dash='solid'),
            marker=dict(size=10, color='orange', symbol='diamond'),
...
def plot_effort_latency(df, effort_sizes):
    fig_el = px.scatter(
        ...
        size=effort_sizes,
        hover_data=['Task', 'Category', 'Notes', 'Effort', 'Priority', 'Latency', 'Created_on'],
        title='Feature Roadmap: Effort vs Latency (Pareto Frontier)',
        labels={'Effort': 'Effort (1-100 Scale, lower is better)', 'Latency': 'Age (days)', 'Pareto_EL': 'Pareto Optimal', 'Priority': 'Priority', 'Created_on': 'Created'}
    )
    ...
    if len(pareto_points_el) > 1:
        pareto_line_el = go.Scatter(
            x=pareto_points_el[:,0],
            y=pareto_points_el[:,1],
            mode='lines+markers',
            name='Pareto Frontier',
            line=dict(color='orange', width=3, dash='solid'),
            marker=dict(size=10, color='orange', symbol='diamond'),
