# [\#443 Issue](https://github.com/V-Sekai/V-Sekai/issues/443) `open`: Create an outfit switch system so that changing clothing context doesn't require an avatar reload
**Labels**: `enhancement`
