...
- Status: Draft
- Deciders: V-Sekai
- Tags: V-Sekai, 20231203-mesh-rwkv
...
Adapting GPT-like generative models for the 3D domain is a challenge. Automated triangle mesh generation needs a reliable solution.
...
The next step is to train RWKV4, which uses these quantized geometric embeddings. Given a sequence of geometric embeddings extracted from the triangles of a mesh, the transformer is trained to predict the codebook index of the next embedding in the sequence.
...
The larger context size of RWKV means that it can remember and use more past information while generating outputs. This feature potentially enables it to handle larger and more complex tasks, provided there are sufficient computational resources.
...
[@meshgpt_2024]: "MeshGPT."  <https://nihalsid.github.io/mesh-gpt/>
[@objaversexl_2024]: "Objaverse-XL."  <https://huggingface.co/datasets/allenai/objaverse-xl>
[@noushermes2vision_2024]: "Nous-Hermes-2-Vision."  <https://huggingface.co/NousResearch/Nous-Hermes-2-Vision-Alpha>
[@machine_learning_elixir_2024]: "Machine Learning in Elixir."  <https://pragprog.com/titles/smelixir/machine-learning-in-elixir/>
[@pytorch_geometric_sageconv_2024]: "PyTorch Geometric SAGEConv."  <https://pytorch-geometric.readthedocs.io/en/latest/generated/torch_geometric.nn.conv.SAGEConv.html>
